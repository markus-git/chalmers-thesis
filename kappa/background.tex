...
As we saw in the section~\ref{functional} and~\ref{domain}, programming in a functional language like Haskell is widely different from the imperative style used in a language like C. In Haskell, users write their program as a mathematical function from its inputs to output. While in C a users would write their programs as a series of sequential steps to execute.
