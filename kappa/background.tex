...
%muls :: (Num a, Typeable a) => [Exp a] -> [Sig a] -> [Sig a]
%muls as bs = zipWith (*) (map repeat as) bs

%dels :: Typeable a => Exp a -> Sig a -> [Sig a]
%dels a = iterate (delay a)
%\end{code}

%Text.

%\begin{code}
%fir :: (Num a, Typeable a) => [Exp a] -> Sig a -> Sig a
%fir xs = sums . muls xs . dels 0
%\end{code}
