...
Now that we have grasp of what domain specific languages in Haskell are and the ideas behind them, the next section will go through a larger example in order to showcase embedded programming in our co-design library.
...
Implementing the dot product as an embedded function in our co-design library is not that different from the earlier implementation using regular Haskell. In fact, we can reimplement the dot product without having to change its definition very much at all:
