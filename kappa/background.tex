...
\noindent Expressions are defined as a type synonym for integers, making use of Haskell's \codei{type} keyword, and the language around our expressions is defined by two functions, one for integer literals, called \codei{const} and another for multiplication, called \codei{times}.
...
\noindent The functions now return a representation of the result rather than the result itself.
