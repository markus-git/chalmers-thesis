...
% TODO: support C style lstset as well as Haskell.
...
\noindent \codei{swap} is true to its name and swaps places of the first element of the pair with the second element. It does so with the help of \codei{fst} and \codei{snd}, which model the similarly named function in standard Haskell and extracts the first and second elements of a pair, respectively. The third function, \codei{pair}, takes the two elements and constructs a new pair.
