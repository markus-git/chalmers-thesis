...
% As an example of the above differences, consider a finite impulse response (FIR) filter. FIR filters are one of the two primary types of digital filters used in digital signal processing applications~\cite{oppenheim1989}, where the second one is infinite impulse response (IIR) filters. The mathematical definition of a FIR filter of rank $N$ is as follows:
