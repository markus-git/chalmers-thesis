...
\begin{code}
component :: Signature (Arr Int32 -> Arr Int32 -> Ref Int32 -> ())
component = inputArray $ \xs -> inputArray $ \ys -> returnVal $ dot xs ys
\end{code}
