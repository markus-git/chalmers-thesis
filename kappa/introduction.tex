...
With the component synthesized and put onto hardware, we write a small software program that interacts with the component:
...
\noindent Where the second argument of our memory-mapping function, \codei{mmap}, is the physical address of the component. With the component in scope, we then declare the necessary arrays and references to hold our input and output values and call the component with them. The result is then read and printed to standard output.
